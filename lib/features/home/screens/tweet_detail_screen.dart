      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(height: 0.5, color: AppColors.borderColor1),
            // Reply composer
                ...
                children: [
                  Row(
                    children: [
                      ...
                      if (tweet.username == 'Elon Musk' ||
                          tweet.username == 'Tech News') ...[
  ...
  Widget _buildRepliesSection(BuildContext context) {
    ...
    return Column(
      children: tweet.replies
          .map(
            (reply) => EnhancedTweetCard(
              tweet: reply,
              onLike: () => Provider.of<TweetViewModel>(
                context,
                listen: false,
              ).likeTweet(reply.id),
              onRetweet: () => Provider.of<TweetViewModel>(
                context,
                listen: false,
              ).retweetTweet(reply.id),
              onReply: () => Provider.of<TweetViewModel>(
                context,
                listen: false,
