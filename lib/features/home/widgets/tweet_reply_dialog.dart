...
class _TweetReplyDialogState extends State<TweetReplyDialog> {
  ...
  Widget _buildHeader(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(
          bottom: BorderSide(color: AppColors.borderColor1, width: 0.5),
        ),
      ),
      child: Row(
        children: [
  ...
  Widget _buildBottomBar(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(
          top: BorderSide(color: AppColors.borderColor1, width: 0.5),
        ),
      ),
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            child: Text('Reply', style: TextStyles.buttonMedium),
          ),
        ],
      ),
    );
