    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.group_outlined, size: 64, color: AppColors.midGray),
            const SizedBox(height: 16),
            Text(
              message,
