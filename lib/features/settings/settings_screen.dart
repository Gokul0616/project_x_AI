        ...
        children: [
          ...
          _buildSection('Security and account access', [
            ...
            _buildSettingsItem(
              ...
              subtitle: 'See information about when you logged into your account and the apps you connected to it.',
              onTap: () {},
            ),
          ]),
          ...
          _buildSection('Privacy and safety', [
            _buildSettingsItem(
              ...
              subtitle: 'Manage what information you allow other people on X to see.',
              onTap: () {},
            ),
            _buildSettingsItem(
          ...
          _buildSection('Accessibility, display, and languages', [
            _buildSettingsItem(
              ...
              title: 'Accessibility',
              subtitle: 'Manage aspects of your X experience such as limiting color contrast and motion.',
              onTap: () {},
            ),
            _buildSettingsItem(
              icon: Icons.display_settings,
              title: 'Display',
              subtitle: 'Manage your font size, color, and background. These settings affect all the X accounts on this browser.',
              onTap: () {},
            ),
            _buildSettingsItem(
              icon: Icons.language,
              title: 'Languages',
              subtitle: 'Manage which languages are used to personalize your X experience.',
              onTap: () {},
            ),
          ]),
          ...
          _buildSection('Additional resources', [
            _buildSettingsItem(
              ...
              title: 'Help Center',
              subtitle: 'Visit our Help Center to read articles and contact our support team.',
              onTap: () {},
            ),
            _buildSettingsItem(
